...
{
    internal class MyWriteMultipleRegistersRequest : AbstractModbusMessageWithData<MyRegisterCollection>, IModbusRequest
    {
        public MyWriteMultipleRegistersRequest()
        {
        }

        public MyWriteMultipleRegistersRequest(byte slaveAddress, ushort startAddress, MyRegisterCollection data)
        ...
        protected override void InitializeUnique(byte[] frame)
        {
            ...
            ByteCount = frame[6];
            Data = new MyRegisterCollection(frame.Slice(7, ByteCount).ToArray());
        }
    }
}
